...
IMAGE_FOLDER="datasets/img/"
cd ~/MoE-LLaVA
HF_DATASETS_OFFLINE=1 TRANSFORMERS_OFFLINE=0 deepspeed moellava/train/train_mem.py \
    --deepspeed ./utils/zero2.json \
    --model_name_or_path LanguageBind/MoE-LLaVA-StableLM-1.6B-4e-384 \
    --version phi \
